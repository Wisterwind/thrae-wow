...
function TinyTipAnchor_Hook(_acehook)
	...
	if acehook and not acehook:IsHooked("GameTooltip_SetDefaultAnchor") then
		acehook:Hook("GameTooltip_SetDefaultAnchor", _G.TinyTipAnchor_SetDefaultAnchor, true)
		_G.TinyTipAnchor_Original_GameTooltip_SetDefaultAnchor = acehook.hooks["GameTooltip_SetDefaultAnchor"]
	end
end
